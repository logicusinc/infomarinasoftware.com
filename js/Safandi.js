    ...
    $('form#form').submit(function () {
        ...
        if (!hasError) {
            ...
            $.post($(this).attr('action'), formInput, function (data) {
                $('form#form').append('<div class="success"><div class="col-md-12"><div class="alert alert-nesto"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><p>Merci! Votre email a été envoyé avec succès. Nous vous contacterons dès que possible.</p></div></div></div>');
            });
            $('.requiredField').val('');
            // $.post($(this).attr('action'), formInput, function (data) {
